            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
                    ...
                    <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Link">
                        <a class="nav-link" href="cliente_ingresso.jsp">
                ...
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="modal" data-target="#exampleModal">
                            <%= cliente.getLogin() + "," %><i class="fa fa-fw fa-sign-out"></i>Logout</a>
                    </li>
                </ul>
            </div>
        </nav>
            ...
            <div class="container-fluid">
                ...
                <div class="col-3">
                    <form action="ControleCliente" method="post">
                        ...
                        <!-- recupera dados do Cliente através do ID -->
                        <% ClienteDAO cDAO = new ClienteDAO();
                        cDAO.buscarUsuario(cliente); %>

                        <div class="form-group">            
                            <label for="exampleInputEmail1"> -Email Atual- </label>
                            <input class="form-control" id="exampleInputEmail1" type="text" name="novoemail" value="<%= cliente.getEmail() %>" placeholder="Digite novo email">
                        </div>
                        <div class="form-group">            
                            <label for="exampleInputTelefone1"> -Telefone Atual- </label>
                            <input class="form-control" id="exampleInputTelefone1" type="text" name="novotelefone" value="<%= cliente.getTelefone() %>" placeholder="Digite novo telefone">
                        </div>
                        <div class="form-group">            
                            <label for="Senha"> -Alterar Senha- </label>
                            <input class="form-control" id="Senha" type="password" name="novasenha" value="<%= cliente.getSenha() %>">
                        </div>
