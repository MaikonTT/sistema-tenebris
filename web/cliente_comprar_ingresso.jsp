    ...
    <body class="fixed-nav sticky-footer bg-dark" id="page-top">
        ...
        <div class="content-wrapper bg-index">
            <div class="container-fluid">
                ...
                <!-- Area de compra -->
                <div>
                    <form action="ControleIngresso" method="post">
                        <div class="form-group">
                            Data: <input type="date" id="data" name="data">
                            Quantidades: <input type="number" name="quant">                        
                            Cupom Promocional: <input type="text" name="codcup"><br/>
                            Pagamento: <input type="checkbox" name="avista"> à Vista  <input type="checkbox" name="credito"> Crédito
