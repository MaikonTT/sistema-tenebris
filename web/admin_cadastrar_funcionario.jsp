                    ...
                    <div class="form-group">
                        <div class="form-row">
                            ...
                            <form action="ControleFuncionario" method="post">
                                <div>    Nome: <input class="form-group" type="text" name="nome"></div>                                 
                                <div>        CPF: <input class="form-group" type="text" name="cpf"></div>
                                <div>Telefone: <input class="form-group" type="text" name="telefone"></div>
                                <div>Endereço: <input class="form-group" type="text" name="endereco"></div>
                                <br/>
                                <hr/>                        
                                <div>     Login: <input class="form-group" type="text" name="login"></div>                   
                                <div>     Senha: <input class="form-group" type="password" name="senha"></div>
