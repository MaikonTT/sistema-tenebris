            ...
            <div class="content-wrapper">
                <div class="container-fluid">
                    ...
                    <%
                        ...
                        ArrayList<Ingresso> listaIngressos = (ArrayList<Ingresso>) request.getAttribute("listaIngressos");                    
                        if (listaIngressos == null) {
                        request.getRequestDispatcher("/ControleIngresso?acao=Listar").forward(request,response);
                        }
                    %>


                    <form action="ControleIngresso" name="acao">
