...
<html lang="en">
    ...
    <body class="fixed-nav sticky-footer bg-dark" id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
            <a class="navbar-brand" href="func_index.jsp">Inicio</a>
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
                    <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Components">
                        <a class="nav-link" href="func_editarperfil_cliente.jsp">
                            <i class="fa fa-fw fa-wrench"></i>
                            <span class="nav-link-text">Administração de Cliente</span>
                        </a>
                    </li>
                </ul>
                ...
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="modal" data-target="#exampleModal">
                            <%= funcionario.getLogin() + "," %><i class="fa fa-fw fa-sign-out"></i>Logout</a>
                    </li>
                </ul>
            </div>
        </nav>
        <div class="content-wrapper bg-index">
            <div class="container-fluid">                
                ...
                request.getRequestDispatcher("/ControleCliente?acao=Listar2").forward(request,response);
                }
                %>
                <form action="ControleCliente" name="tabela">
